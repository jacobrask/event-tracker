...
MiscHelper.isSamePage = function (url1, url2) {
  ...
  return url1.protocol === url2.protocol && url1.host === url2.host && url1.pathname === url2.pathname && (0, _lodash2.default)(url1.query, url2.query);
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(50), __webpack_require__(126)(module)))
...
exports.Filters = exports.MiscUtil = exports.HttpTracker = exports.ConsoleTracker = exports.EventTracker = undefined;

var _eventTracker = __webpack_require__(333);

var _eventTracker2 = _interopRequireDefault(_eventTracker);

var _consoleTracker = __webpack_require__(343);

var _consoleTracker2 = _interopRequireDefault(_consoleTracker);

var _httpTracker = __webpack_require__(344);

var _httpTracker2 = _interopRequireDefault(_httpTracker);

var _filters = __webpack_require__(345);
...
exports.MiscUtil = _miscUtil2.default;
...
var _domUtil = __webpack_require__(335);

var _domUtil2 = _interopRequireDefault(_domUtil);

var _arrayUtil = __webpack_require__(128);

var _arrayUtil2 = _interopRequireDefault(_arrayUtil);

var _env = __webpack_require__(336);

var _env2 = _interopRequireDefault(_env);

var _eventHelper = __webpack_require__(341);
      ...
      var trackJump = function trackJump(hash) {
        if (self.oldHash !== hash) {
          ...
          self.track('jump', {
            ...
            source: {
              url: (0, _lodash2.default)(_miscUtil2.default.parseUrl(document.location), {
      ...
      if (this.options.trackElementClicks) {
        _domUtil2.default.monitorElements(this.options.clickElementSelectors, function (el) {
          _eventHelper2.default.onevent(el, 'click', true, function (e) {
            ...
            var value = {
              eventCustomData: {
                target: (0, _lodash2.default)({ url: parsedUrl }, _domUtil2.default.getNodeDescriptor(el))
              }
            };
        ...
        _eventHelper2.default.onsubmit(function (e) {
          if (e.form) {
            ...
            self.trackLater('formsubmit', {
              eventCustomData: { form: (0, _lodash2.default)({ formId: e.form.formId }, _domUtil2.default.getFormData(e.form)) }
            });
          }
        });
      }
        ...
        for (var _iterator = this.outbox[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (event_type === this.options.eventTypePrefix + ':redirect') {
            try {
              ...
              var targetUrl = _miscUtil2.default.unparseUrl(message.value.eventCustomData.target.url);
...
DomUtil.simulateMouseEvent = function (element, eventName, options) {
  ...
  if (document.createEvent) {
    ...
    oEvent = (0, _lodash2.default)(evt, options);
    try {
...
var _detectBrowser = __webpack_require__(337);

var _justDetectAdblock = __webpack_require__(340);
...
function getNodeVersion() {
  ...
  return isNode ? {
    ...
    os: __webpack_require__(339).type().toLowerCase()
  } : null;
}
...
module.exports = {
  ...
  isDetected: function(){
    ...
    var bait = document.createElement('div');
		bait.setAttribute('class', 'pub_300x250 pub_300x250m pub_728x90 text-ad textAd text_ad text_ads text-ads text-ad-links ad-placement');
...
var _handler = __webpack_require__(342);
...
var HttpTracker = function () {
  function HttpTracker() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, HttpTracker);
